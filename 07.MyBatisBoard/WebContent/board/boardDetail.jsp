...
<table border="1" style="width: 80%">
	<tr>
		<th>작성자</th><td><%=dto.getB_writer() %></td>
		<th>조회수</th><td align="center"><%=dto.getB_readcount() %></td>
	</tr>
	<tr>
		<th>제목</th>
		<td colspan="3" align="center" style="font-weight: bold"><%=dto.getB_subject() %></td>
	</tr>
	<tr>
		<th>내용</th>
	...
	<tr align="center">
		...
		<td colspan="3">
			...
			<input type="button" value="수정하기" onclick="fnupdate('${dto.b_pwd}')"/>
